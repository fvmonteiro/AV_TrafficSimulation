...
<sc version="201602" id="1" name="" frequency="1" steps="0" defaultIntergreenMatrix="0" interstagesUsingMinDurations="true" checkSum="2407583631">
  <signaldisplays>
  ...
  <sgs>
    <sg id="1" name="Signal group 1" defaultSignalSequence="7">
      <defaultDurations>
        <defaultDuration display="1" duration="10000" />
        <defaultDuration display="3" duration="15000" />
        <defaultDuration display="4" duration="5000" />
      </defaultDurations>
    </sg>
  </sgs>
  <intergreenmatrices />
  <progs>
    <prog id="1" cycletime="65000" switchpoint="0" offset="0" intergreens="0" fitness="0.000000" vehicleCount="0" name="Signal program 1">
      <sgs>
        <sg sg_id="1" signal_sequence="7">
          ...
          <fixedstates>
            <fixedstate display="4" duration="5000" />
          </fixedstates>
        </sg>
      </sgs>
    </prog>
